...
namespace Aurigin
{
	...
	public class SyringeControlForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(SyringeControlForm));
			...
			// btnInitialize
			// 
			this.btnInitialize.Location = new System.Drawing.Point(16, 48);
			...
			// btnEmpty
			// 
			this.btnEmpty.Location = new System.Drawing.Point(152, 48);
			...
			// btnAspirate
			// 
			this.btnAspirate.Location = new System.Drawing.Point(16, 152);
			...
			// btnDispense
			// 
			this.btnDispense.Location = new System.Drawing.Point(152, 152);
			...
			// trkVolume
			// 
			this.trkVolume.Location = new System.Drawing.Point(80, 80);
			this.trkVolume.Name = "trkVolume";
			this.trkVolume.Size = new System.Drawing.Size(152, 42);
			...
			// lblVolume
			// 
			this.lblVolume.Location = new System.Drawing.Point(264, 88);
			...
			// lblSpeedCode
			// 
			this.lblSpeedCode.Location = new System.Drawing.Point(232, 120);
			...
			// trkSpeed
			// 
			this.trkSpeed.Location = new System.Drawing.Point(80, 112);
			this.trkSpeed.Name = "trkSpeed";
			this.trkSpeed.Size = new System.Drawing.Size(152, 42);
			...
			this.toolTip1.SetToolTip(this.button1, "Converts Volume to Syringe Steps (informational only)");
			...
			this.button2.Text = "Prime Once";
			this.toolTip1.SetToolTip(this.button2, "Use Volume and Speed Code To Prime Once");
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(296, 48);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(72, 24);
			this.button3.TabIndex = 16;
			this.button3.Text = "Prime ->";
			this.toolTip1.SetToolTip(this.button3, "Use Volume and Speed Code to Prime N Times");
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// numUpDownLoop
			// 
			this.numUpDownLoop.AllowDrop = true;
			this.numUpDownLoop.Location = new System.Drawing.Point(376, 48);
			this.numUpDownLoop.Minimum = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			...
			this.numUpDownLoop.Value = new System.Decimal(new int[] {
																		2,
																		0,
																		0,
																		0});
			...
			this.btnPurge.Location = new System.Drawing.Point(208, 8);
			this.btnPurge.Name = "btnPurge";
			this.btnPurge.Size = new System.Drawing.Size(72, 24);
			this.btnPurge.TabIndex = 19;
			this.btnPurge.Text = "Air Purge";
			this.toolTip1.SetToolTip(this.btnPurge, "Aspirate volume (air) from tip, Aspirate volume from reservoir, empty out tip");
			this.btnPurge.Click += new System.EventHandler(this.btnPurge_Click);
			// 
			// btnSetPrecise
			// 
			this.btnSetPrecise.Location = new System.Drawing.Point(16, 192);
			...
			// txtPreciseVol
			// 
			this.txtPreciseVol.Location = new System.Drawing.Point(184, 192);
...
//			return (double) this.trkVolume.Value;
		...
		{
			AtSyringe.Control.InitPumpControl();
		...
		{
			int index = this.comboBoxSyringe.SelectedIndex;
			MessageBox.Show(lblVolume.Text+"ul = " +AtSyringe.Control.VolumeToSteps(index, GetVolume()).ToString()+" steps");
		}
		...
		private void button2_Click(object sender, System.EventArgs e)
		{
			...
			if (syringeControl.EmptySyringe(index, slow_speed, true) != 0)
			{
				System.Windows.Forms.MessageBox.Show("Failed to execute syringe command", "SYRINGE ERROR");
			}
...
//			SetValvePosition(SyringeValvePosition.BypassPosition);   Leave it in the output position
		}
...
//			SetValvePosition(SyringeValvePosition.BypassPosition);    Lets leave it in output position.
		}
