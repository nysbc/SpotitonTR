...
//		public const string PiezoSequenceFile = @".\PiezoSequences.xml"; // kc060524
    ...
    public class MachineConfigurationData
	{
        ...
        public decimal              AspirateVolume;         // sample aspiration volume for each piezo
        ...
        public int usAmp;                       // Amplitude 1800
        public int usFreqSweepCycles;           // 2,  will sweep through these frequencies twice
